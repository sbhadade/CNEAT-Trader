...
*/
    ...
    public:
        ...
        */
        ...
        template<typename T>
        explicit
        GenericValue(T b, CEREAL_RAPIDJSON_ENABLEIF((internal::IsSame<bool, T>))) CEREAL_RAPIDJSON_NOEXCEPT  // See #472
#else
        ...
        */
         ...
         */
        template<typename T>
        friend CEREAL_RAPIDJSON_DISABLEIF_RETURN((internal::IsGenericValue<T>), (bool))
        ...
        */
        template<typename T>
        CEREAL_RAPIDJSON_DISABLEIF_RETURN(
                (internal::NotExpr<internal::IsSame<typename internal::RemoveConst<T>::Type, Ch> >), (GenericValue & ))
        operator[](T *name) {
            ...
            switch (GetType()) {
                ...
                case kObjectType:
                    ...
                    for (ConstMemberIterator m = MemberBegin(); m != MemberEnd(); ++m) {
                        ...
                        if (CEREAL_RAPIDJSON_UNLIKELY(!handler.Key(m->name.GetString(), m->name.GetStringLength(),
